...
export function useConfiguracionEmpresa() {
    ...
    const aplicarDatosApi = (datos: any) => {
        Object.assign(form, {
            ...
            informacion_adicional: datos.informacion_extra?.informacion_adicional || '',
            restricciones_especiales: datos.informacion_extra?.restricciones_especiales || '',
            standard_size: datos.empresa?.standard_size || datos.standard_size || 'UNICA',
    ...
    const guardarConfiguracion = async () => {
        ...
        try {
            ...
            const datosGuardar = {
                ...
                ruc: form.ruc ? String(form.ruc) : null,
                razon_social: form.razon_social ? String(form.razon_social) : null,
                ...
                informacion_adicional: form.informacion_adicional ? String(form.informacion_adicional) : null,
                ...
                standard_size: String(form.standard_size || 'UNICA'),
