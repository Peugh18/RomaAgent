            ...
            <form @submit.prevent="submit" class="mt-8 space-y-6">
                ...
                <CrmPanel>
                    <div class="mb-4 pb-3 border-b border-border">
                        ...
                        <p class="text-xs text-muted-foreground mt-0.5">Precio normal para WhatsApp/web. Precio TikTok para clientas que vienen de TikTok Shop.</p>
                    </div>
                ...
                <CrmPanel>
                    <div class="mb-4 pb-3 border-b border-border flex items-center justify-between flex-wrap gap-4">
                        <div>
                            ...
                            <p class="text-xs text-muted-foreground mt-0.5">Color, foto y stock en la talla estándar de la tienda.</p>
                        </div>
                        <Button
                            type="button"
                            variant="secondary"
